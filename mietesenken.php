...
<!-- End Facebook Pixel Code -->
  ...
  <body>
	<noscript>
	 <img height="1" width="1" style="display:none" alt="FB Pixel" src="https://www.facebook.com/tr?id=215303996265249&ev=PageView&noscript=1"/>
	</noscript>
       ...
       <nav class="navbar-expand-lg naav">
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="mailto:kontakt@mietheld.at"><img src="photo/email.png" alt="email" class="email"/><span class="img1"> kontakt@mietheld.at </span></a>
                  </li>
                  <li class="nav-item">
...
<div class="final_tick_image">
                                                            <img alt="" src="photo/1sDamef.png" class="tick_image" style="cursor: auto;margin-bottom: 10px!important;">
