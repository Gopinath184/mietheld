...
<style>
  ...
  <body>
	<noscript>
	<img height="1" width="1" style="display:none" alt="FB Pixel" src="https://www.facebook.com/tr?id=215303996265249&ev=PageView"/>
	</noscript>
...
<!-- <div id="notificationDiv" style="background-color: red; height:30px;">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav">
                  <li class="nav-item active">
                    <a class="nav-link" href="tel:01348030"><img src="photo/phone.png" alt="Phone" class="phone"/>  <span class="img">01 34 80 30</span></a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="mailto:kontakt@mietheld.at"><img src="photo/email.png" alt="E-Mail" class="email"/><span class="img1"> kontakt@mietheld.at </span></a>
                  </li>
                  <li class="nav-item">
    ...
    <div class="">
      <div class="">
        <h1 class="content">Mietheld senkt Mietgeld</h1>
      </div>
      <div class="">
        <div class="">
          <div class="">
...
<!--     <span class="glyphicon form-control-feedback" aria-hidden="true"></span> -->
    <div  id="Quadratmeter_required"  class="help-block with-errors text-danger" style="display: none">Bitte f&uuml;llen Sie dieses Feld aus</div>
  </div>
...
<!--     <span class="glyphicon form-control-feedback" aria-hidden="true"></span> -->
    <div  id="Miete_required" class="help-block with-errors text-danger"  style="display: none">Bitte f&uuml;llen Sie dieses Feld aus</div>
  </div>
          ...
          <div class="full_div_check row">
            ...
            <div class="input_div_check col-xs-12">
              ...
              <label class="label_check">
                      <img src="img/form/formimg1.jpg" alt="Altbau" class="img-thumbnail img-check" width="100" height="100">
                      <input type="radio" name="second_step_checkbox" class="but image_inside_checkbox second_step_checkbox" onclick="nextPrev(1,'40')" value="altbau">
              </label>
              <label class="label_check">
                      <img src="img/form/formimg2.jpg" alt="Neubau" class="img-thumbnail img-check" width="100" height="100">
                      <input type="radio" name="second_step_checkbox" class="image_inside_checkbox second_step_checkbox" onclick="nextPrev(1,'40')" value="neubau">
              </label>    
            ...
            <div class="input_div_check col-xs-12">
              ...
              <label class="label_check">
                      <img src="img/form/formimg3.jpg" alt="Gemeindebau" class="img-thumbnail img-check" width="100" height="100" >
                      <input type="radio" name="second_step_checkbox"  class="image_inside_checkbox second_step_checkbox" onclick="nextPrev(1,'40')" value="gemeindebau">
            </label>
            <label class="label_check">
                      <img src="img/form/formimg4.jpg" alt="Unbekannt" class="img-thumbnail img-check" width="100" height="100" >
                      <input type="radio"  name="second_step_checkbox" class="image_inside_checkbox second_step_checkbox" onclick="nextPrev(1,'40')" value="unbekannt">
            </label>
            </div>
...
<div class="tab">
   ...
   <div class="full_div_check row">
    ...
    <label class="label_check">
      ...
      <img src="img/form/form_2_img1.jpg" alt="Befriesteter Mietvertrag" class="img-thumbnail img-check" width="100" height="100" >
      <input type="radio" name="third_step_checkbox" class="image_inside_checkbox third_step_checkbox" onclick="nextPrev(1,'60')" value="befristeter">
    </label>


    <label class="label_check">
        <img src="img/form/form_2_img2.jpg" alt="Unbefriesteter Mietvertrag" class="img-thumbnail img-check" width="100" height="100" >
        <input type="radio" name="third_step_checkbox"  class="image_inside_checkbox third_step_checkbox" onclick="nextPrev(1,'60')" value="unbefristeter">
     </label>
...
<div class="tab">
   ...
   <div class="full_div_check row">
            ...
            <div class="input_div_check col-xs-12">
    <label class="label_check">
     <img src="img/form/form3_img_1.jpg" alt="Wohne dort weniger als 3 Jahre" class="img-thumbnail img-check" width="100" height="100" >
    <input type="radio" name="fouth_step_checkbox"  class="image_inside_checkbox fouth_step_checkbox" onclick="nextPrev(1,'80')" value="weniger">
  </label>

    <label class="label_check">
        <img src="img/form/form3_img_2.jpg" alt="Wohne dort l&uml;nger als 3 Jahre" class="img-thumbnail img-check" width="100" height="100" >
        <input type="radio" name="fouth_step_checkbox" class="image_inside_checkbox fouth_step_checkbox" onclick="nextPrev(1,'80')" value="länger">
  </label>
...
<div class="tab">
 <div class="form-group has-feedback">
  ...
  <!--     <span class="glyphicon form-control-feedback" aria-hidden="true"></span> -->
      <div  id="phone_required"  class="help-block with-errors text-danger " style="display: none; font-size:18px; margin-left: 46px; font-family: wf_736a916d09a94cd392744ed6a; text-align:center">Bitte gib' eine g&uuml;ltige Telefonnummer ein</div>
    </div>
...
<img alt="Final Tick" src="img/final-tick.png" class="tick_image" style="cursor: auto;">
          ...
          <div class="row">
            ...
            <div class="col-md-7">
              ...
              <div class="sofunction3">
                  3 ‣ Wir übernehmen alle Kosten und erhalten nur im Erfolgsfall eine<br> Provision auf deinen finanziellen Vorteil. 
              </div>
              <div>
...
<div class="popup__overlay">
  <div class="popup" id="popupVid">
    ...
    <iframe id="popup_iframe" src="https://www.youtube.com/embed/L9e49RRkVSI?showinfo=0&rel=0&enablejsapi=1" allowfullscreen style="border:0"></iframe>
  </div>
</div>
...
<div class="col-md-12 interview-section">
          ...
          <div class="col-md-12">
          <div class="">
              <h2 class="interview-heading">Interview: Warum Mietheld beauftragen?</h2>
          </div>
          </div>
          <div class="col-md-12">
          <div class="video-section">
            <iframe style="width: 800px;    height: 450px;" width="560" height="315" src="https://www.youtube.com/embed/HpI8Vi8CpJ0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
              </div>
          </div>
</div>     
      ...
      <div class="col-md-12 du">
          <div class="row">
          <h2 class="du1">Du kannst nur gewinnen</h2>
          <span class="du2">
            ...
            <div>
                ...
                <div>
                  ...
                  <div>
                    <!-- accordion starting -->
                    <div class="clicker">
                      <h2 class="clicker-heading">Fragen &amp; Antworten</h2>
